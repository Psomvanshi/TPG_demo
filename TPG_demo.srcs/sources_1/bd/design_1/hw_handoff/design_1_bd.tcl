...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net Net [get_bd_pins VGA_B/Din] [get_bd_pins VGA_G/Din] [get_bd_pins VGA_R/Din] [get_bd_pins v_axi4s_vid_out_0/vid_data]
  ...
  connect_bd_net -net xlslice_0_Dout [get_bd_ports VGA_R] [get_bd_pins VGA_R/Dout]
  connect_bd_net -net xlslice_1_Dout [get_bd_ports VGA_G] [get_bd_pins VGA_G/Dout]
  connect_bd_net -net xlslice_2_Dout [get_bd_ports VGA_B] [get_bd_pins VGA_B/Dout]
